...
type Config struct {
	...
	TelegramChannelID    int           `hcl:"telegram_channel_id" env:"TELEGRAM_CHANNEL_ID" required:"true"`
	DatabaseDSN          string        `hcl:"database_dsn" env:"DATABASE_DSN" default:"postgres://postgres:postgres@localhost:5432/news-telegram-bot?sslmode=disable"`
...
func Get() Config {
	once.Do(func() {
		loader := aconfig.LoaderFor(&cfg, aconfig.Config{
			...
			Files:     []string{"./config.hcl", "./config.auto.hcl"},
